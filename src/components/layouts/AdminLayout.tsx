...
import { LogOut, Home, Users, Store, ShoppingCart, Gift, RotateCcw, Settings, Menu, X } from 'lucide-react';
...
export const AdminLayout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <aside className="hidden lg:flex w-64 bg-background border-r border-border shadow-lg flex-col">
        <SidebarContent />
      </aside>
