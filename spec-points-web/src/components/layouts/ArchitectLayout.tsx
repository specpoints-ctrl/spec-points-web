...
const Logo = () => (
  <svg width="26" height="26" viewBox="0 0 28 28" fill="none" aria-hidden>
    <polygon points="14,2 26,8 26,20 14,26 2,20 2,8" fill="none" stroke="url(#lga)" strokeWidth="1.5" />
    <circle cx="14" cy="14" r="2.5" fill="url(#lga)" />
    <defs>
      ...
      <div className="px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-[0.18em] text-sidebar-foreground/50 mt-0.5">Arquitecto</p>
          </div>
        </div>
      </div>
